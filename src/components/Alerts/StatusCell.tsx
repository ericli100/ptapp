...
import { StatusCellPropsType } from './models/statusCellPropsType';
...
export default function StatusCell({ status }: StatusCellPropsType) {
  const badgeClassName = clsx(
    ...
    'inline-block flex-shrink-0 rounded-full bg-gray-100 px-2 py-0.5 my-2 text-xs font-medium text-navy-800 capitalize'
  );
